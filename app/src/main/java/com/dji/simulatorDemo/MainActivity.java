...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public  Button mboton,mbotonland;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mitexto = findViewById(R.id.textview_simulator);

        mDatabase = FirebaseDatabase.getInstance().getReference();//referencia al nodo principal de base de datos
        mboton = findViewById(R.id.btn_take_off);
        mbotonland = findViewById(R.id.btn_land);
        mDatabase.child("0001").addValueEventListener(new ValueEventListener() {
            @Override
            //            public void onDataChange(DataSnapshot dataSnapshot) {
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    Z = dataSnapshot.child("z").getValue().toString();
                    X = dataSnapshot.child("x").getValue().toString();
                    float pX_ = Float.parseFloat(X);
                    Y = dataSnapshot.child("y").getValue().toString();
                    float pY_ = Float.parseFloat(Y);
                    //Toast.makeText(context,nombre,Toast.LENGTH_SHORT).show();
                    //Log.d("TAG", "Valor de x: " + pX_);
                    //textView.setText("take off" );
                    mitexto.setText("el nombre es:" + pX_ + " " + pY_ + " " + Z );
                    listener_drone(Z);
                }
            }
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.d("Firebase", "Error al leer datos: " + databaseError.getMessage());
            }
        });
        mboton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mitexto.setText("take off" + pX_ + " " + pY_ + " " + Z );
        ...
        mbotonland.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Código a ejecutar cuando se hace clic en el botón
    ...
    public void listener_drone(String it){
        if(it.equals("0")){
    ...
    private void initUI() {
        ...
        /*controla altura, rotaciòn sobre el eje propio*/
            @Override
            public void onTouch(OnScreenJoystick joystick, float pX, float pY) {
                pX=pX_;
                pY=pY_;
